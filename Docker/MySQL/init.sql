...
CREATE TABLE chats (
    ...
    chat_name VARCHAR(50) UNIQUE NOT NULL,
    detail VARCHAR(255),
...
INSERT INTO users(id, user_name, email,  password, icon_img, created_at) VALUES('a', 'テスト', 'demota@gmail.com', 'a', 'default_image.png', '2025-07-01');
INSERT INTO chats(id, user_id, chat_name, detail, chat_type, created_at, updated_at) VALUES('aaaaaaaaaa', 'a', '明太子を語る会', "明太子について語りましょう！！", 0, '2025-07-01', '2025-07-01');
INSERT INTO chats(id, user_id, chat_name, detail, chat_type, created_at, updated_at) VALUES('bbbbbbbbbb', 'a', 'スケトウダラを語る会', "スケトウダラについてダラダラ語りましょう！！", 0, '2025-07-02', '2025-07-02');
